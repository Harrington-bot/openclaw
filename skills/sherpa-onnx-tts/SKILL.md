    ...
    "openclaw":
      {
        ...
        "install":
          [
            ...
            {
              "id": "download-runtime-linux-arm64",
              "kind": "download",
              "os": ["linux"],
              "arch": ["arm64"],
              "url": "https://github.com/k2-fsa/sherpa-onnx/releases/download/v1.12.23/sherpa-onnx-v1.12.23-linux-aarch64-shared-cpu.tar.bz2",
              "archive": "tar.bz2",
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.openclaw/tools/sherpa-onnx-tts/runtime",
              "label": "Download sherpa-onnx runtime (Linux arm64)",
            },
            {
